...
describe('Context', function () {
  ...
  describe('new Context(options)', function () {
    ...
    it('callback - 如果指定了，必须为一个函数', function () {
      ...
      new Context({manager, callback: function () {}});
    });
    ...
    it('writeLog - 如果指定了，必须为一个函数', function () {
      ...
      new Context({manager, writeLog: function () {}});
    });
  ...
  describe('call(name, params)', function () {
    ...
    it('callback(err)', function (done) {
      new Context({manager}).call('testError', {msg: 'test'}, (err, ret) => {
    ...
    it('Promise.catch(err)', function (done) {
      new Context({manager}).call('testError', {msg: 'test'}).then(ret => {
  ...
  describe('next(name, params)', function () {
    ...
    it('callback(err)', function (done) {
      new Context({manager}).call('bridge', {name: 'testError', msg: 'test'}, (err, ret) => {
        assert.notEqual(err, null);
        assert.equal(err.message, 'test');
        done();
      });
    ...
    it('Promise.catch(err)', function (done) {
      new Context({manager}).call('bridge', {name: 'testError', msg: 'test'}).then(ret => {
